...
## Módulo: Front-end
 ...
 Repositório possuí projeto desenvolvido no período que estive na **Trybe**, abordando conceitos de tudo o que vimos até agora: `funções assíncronas`, desenvolvimento com `React`, `Componente com estados e eventos`, `Ciclo de vida de um componente`, `React Router`, Metodologias ágeis: `Kanban e Scrum`, testes com `React Testing Library`, gerenciamento de estado com `Redux`, `Context API` e `React Hooks`, isso em grupo utilizando tanto a metodologia Kanban como Scrum em um grupo de 5 pessoas aqui na **Trybe**.
...
Figma do protótipo final do projeto [figma](https://www.figma.com/file/9WXNFMewKRBC5ZawU1EXYG/%5BProjeto%5D%5BFrontend%5D-Recipes-App)
