...
const MealRecipeInProgress: React.FC = () => {
  ...
  const handleCheckboxChange = (ingredientText: string) => {
    ...
    // Salvar no localStorage inProgressRecipes
    const inProgress = JSON.parse(localStorage.getItem('inProgressRecipes') || '{"meals":{},"drinks":{}}');
    if (!inProgress.meals) inProgress.meals = {};
    inProgress.meals[id] = updated;
